...
import srj_json from "./pour-via-escape-06.json"
import {
  getBounds,
...
const srj_root = Array.isArray(srj_json) ? srj_json[0] : srj_json
const srj = srj_root.simple_route_json ?? srj_root.simpleRouteJson ?? srj_root

test("pour-via-escape-06", async () => {
