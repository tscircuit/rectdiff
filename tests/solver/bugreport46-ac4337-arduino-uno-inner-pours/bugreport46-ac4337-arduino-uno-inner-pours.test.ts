...
import { bugreport46ArduinoUnoInnerPoursSrj as srj } from "pages/bugreport46-ac4337-arduino-uno-inner-pours.page"
import {
  getBounds,
...
test("bugreport46-ac4337-arduino-uno-inner-pours mesh layer snapshots", async () => {
  ...
  for (const z of Array.from({ length: layerCount }, (_, index) => index)) {
